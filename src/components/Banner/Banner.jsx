    ...
    return (
        <div className="mb-9 ">
            <div className=" h-[60vh] relative">
                ...
                <form onSubmit={handleSearch} className="absolute w-3/4 md:w-1/2 lg:w-1/3 flex top-36 md:top-36 lg:top-44 left-12 md:left-40 lg:left-80">
                    
                        <input type="text" name="categoryName" placeholder="Search here...." className="w-3/4 px-3 py-1 md:px-5 md:py-2 rounded-l-lg" />
