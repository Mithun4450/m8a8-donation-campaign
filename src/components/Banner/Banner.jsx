    ...
    return (
        <div className="mb-9 ">
            <div className=" h-[60vh] relative">
                <img className="h-[60vh] w-full opacity-10 z-0 -mt-24  " src={myBanner} alt="" />
                ...
                <div className="absolute mx-auto bottom-1/3 left-12 md:left-1/3 flex flex-col md:flex-row ">
